 ...
 * @author Jasper Potts
 */
public class CurvedFittedAreaChart extends AreaChart<String, Number> {

    public CurvedFittedAreaChart(CategoryAxis xAxis, NumberAxis yAxis) {
        super(xAxis, yAxis);
    }
    ...
    protected void layoutPlotChildren() {
        ...
        for (int seriesIndex = 0; seriesIndex < getDataSize(); seriesIndex++) {
            final Series<String, Number> series = getData().get(seriesIndex);
